...
class AttachAssignments extends StatefulWidget {
  @override
  _AttachAssignmentsState createState() => _AttachAssignmentsState();
}

class _AttachAssignmentsState extends State<AttachAssignments> {
